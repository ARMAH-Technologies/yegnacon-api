                                            ...
                                            <td width="300" height="50" align="center">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="<?php echo $message->embed(public_path().'/logo.png'); ?>" alt="Logo" border="0" width="140" height="50" style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
                                    ...
                                    <table bgcolor="#eacb3c" width="250" height="50" border="0" align="right" valign="middle" cellpadding="0" cellspacing="0" border="0" class="devicewidth">
                                        ...
                                        <tr>
                                            <td height="50" align="center" valign="middle" style="font-family: Helvetica, arial, sans-serif; font-size: 13px;color: #282828" st-content="menu">
                                                <a href="http://www.yegnacon.com/app/src/#/main/public/home" style="color: #282828;text-decoration: none;">Home</a>
                                                &nbsp;&nbsp;&nbsp;
                                                <a href="http://www.yegnacon.com/app/src/#/main/public/vacancy" style="color: #282828;text-decoration: none;">Jobs</a>
                                                &nbsp;&nbsp;&nbsp;
                                                <a href="http://www.yegnacon.com/app/src/#/main/public/contact" style="color: #282828;text-decoration: none;">Contact</a>
                                                &nbsp;&nbsp;&nbsp;
                                            </td>
                                        </tr>
                                        </tbody>
                                    ...
                                    <table width="560" align="center" cellpadding="0" cellspacing="0" border="0" class="devicewidthinner">
                                        ...
                                        <tr>
                                            <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:center; line-height: 24px;">
                                                Thank you for registering at Yegnacon.com. Our scubscription package offers a wide range of options, click the button below to learn more
                                            </td>
                                        </tr>
                                        <!-- End of content -->
                                        <!-- Spacing -->
                                        ...
                                        <tr>
                                            <td>
                                                <table width="120" height="32" bgcolor="#eacb3c" align="center" valign="middle" border="0" cellpadding="0" cellspacing="0" style="border-radius:3px;" st-button="learnmore">
                                                    <tbody>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td height="14" align="center" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 13px; font-weight:bold;color: #ffffff; text-align:center; line-height: 14px; ; -webkit-text-size-adjust:none;" st-title="fulltext-btn">
                                                            <a style="text-decoration: none;color: #282828; text-align:center;" href="http://www.yegnacon.com/app/src/#/main/public/contact">Subscribe</a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="9" align="center" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                    ...
                                    <table width="280" align="left" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                        ...
                                        <tr>
                                            <td width="280" height="140" align="center" class="devicewidth">
                                                <img src="<?php echo $message->embed(public_path().'/buisness-directory.jpg'); ?>" alt="Business Directory" border="0" width="280" height="177" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                            </td>
                                        </tr>
                                        <!-- /image -->
                                        </tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <table width="280" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                    ...
                                                    <!-- Spacing -->
                                                    <tr>
                                                        <td width="100%" height="11" style="font-size:1px; line-height:1px; mso-line-height-rule: exactly;">&nbsp;</td>
                                                    </tr>
                                                    <!-- /Spacing -->
                                                    <!-- content -->
                                                    <tr>
                                                        <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:left; line-height: 24px;">
                                                            Yegnacon Offers an organized and well sorted business directory
                                                            you can find Contractors, consultants, suppliers and professionals
                                                        </td>
                                                    </tr>
                                                    <!-- end of content -->
                                                    <!-- Spacing -->
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="120" height="32" bgcolor="#eacb3c" align="left" valign="middle" border="0" cellpadding="0" cellspacing="0" style="border-radius:3px;" st-button="learnmore">
                                                                ...
                                                                <tr>
                                                                    <td height="14" align="center" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 13px; font-weight:bold;color: #ffffff; text-align:center; line-height: 14px; ; -webkit-text-size-adjust:none;" st-title="fulltext-btn">
                                                                        <a style="text-decoration: none;color: #282828; text-align:center;" href="http://www.yegnacon.com/app/src/#/main/public/aboutus">Learn More</a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td height="9" align="center" style="font-size:1px; line-height:1px;">&nbsp;</td>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="280" align="right" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                        ...
                                        <tr>
                                            <td width="280" height="140" align="center" class="devicewidth">
                                                <img src="<?php echo $message->embed(public_path().'/vacancies.jpg'); ?>" alt="Vacancies" border="0" width="280" height="160" style="display:block; border:none; outline:none; text-decoration:none;" class="col2img">
                                            </td>
                                        </tr>
                                        <!-- /image -->
                                        </tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <table width="280" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                                    ...
                                                    <tr>
                                                        <td style="font-family: Helvetica, arial, sans-serif; font-size: 14px; color: #889098; text-align:left; line-height: 24px;">
                                                            Latest Vacancies and Tenders are posted here at Yegnacon, unlike other vendors,
                                                            at yegnacon subscribers are able to post too
                                                        </td>
                                                    </tr>
                                                    <!-- end of content -->
                                                    <!-- Spacing -->
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="120" height="32" bgcolor="#eacb3c" align="left" valign="middle" border="0" cellpadding="0" cellspacing="0" style="border-radius:3px;" st-button="learnmore">
                                                                ...
                                                                <tr>
                                                                    <td height="14" align="center" valign="middle" style="font-family: Helvetica, Arial, sans-serif; font-size: 13px; font-weight:bold;color: #ffffff; text-align:center; line-height: 14px; ; -webkit-text-size-adjust:none;" st-title="fulltext-btn">
                                                                        <a style="text-decoration: none;color: #282828; text-align:center;" href="http://www.yegnacon.com/app/src/#/main/public/vacancy">Learn More</a>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td height="9" align="center" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                    ...
                                    <table  width="150" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth">
                                        ...
                                        <tr>
                                            <td width="43" height="43" align="center">
                                                <div class="imgpop">
                                                    <a target="_blank" href="https://www.facebook.com/yegnacon">
                                                        <img src="<?php echo $message->embed(public_path().'/facebook.png'); ?>" alt="Facebook Page" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td width="43" height="43" align="center">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="<?php echo $message->embed(public_path().'/twitter.png'); ?>" alt="Twitter Page" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
                                            </td>
                                            <td align="left" width="20" style="font-size:1px; line-height:1px;">&nbsp;</td>
                                            <td width="43" height="43" align="center">
                                                <div class="imgpop">
                                                    <a target="_blank" href="#">
                                                        <img src="<?php echo $message->embed(public_path().'/linkedin.png'); ?>" alt="LinkedIn Page" border="0" width="43" height="43" style="display:block; border:none; outline:none; text-decoration:none;">
                                                    </a>
                                                </div>
                                            </td>
                                        </tr>
